...
public class FlightBot {
    ...
    private static EntityPlayerSP player = CRIMSON.player;
    ...
    private static void takeOff() {
        ...
        if (player.onGround) {
            ...
            player.connection.sendPacket(new CPacketPlayer.Rotation(CRIMSON.player.rotationYaw, -20, false));
