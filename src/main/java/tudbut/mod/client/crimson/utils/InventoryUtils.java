...
public class InventoryUtils {
    ...
    public static void clickSlot(int slot, ClickType type, int key) {
        CRIMSON.mc.playerController.windowClick(CRIMSON.mc.player.inventoryContainer.windowId, slot, key, type, CRIMSON.mc.player);
    }
    ...
    public static void inventorySwap(int slot0, int slot1, long delay) {
        ...
        GuiScreen screen = CRIMSON.mc.currentScreen;
        ...
        if (doResetScreen)
            CRIMSON.mc.displayGuiScreen(screen);
