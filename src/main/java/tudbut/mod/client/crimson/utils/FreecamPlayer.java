...
import tudbut.mod.client.crimson.mods.Freecam;
...
public class FreecamPlayer extends EntityOtherPlayerMP
{
    ...
    public void onLivingUpdate()
    {
        ...
        CRIMSON.mc.renderChunksMany = false;
        CRIMSON.mc.player.setInvisible(false);
        setInvisible(true);
        
        inventory.copyInventory(CRIMSON.player.inventory);
