...
public class Setting {
    ...
    public static GuiCRIMSON.Button createInt(int min, int max, int step, String string, Module module, String field, Runnable onClick) {
        final int[] locVal = {(Integer) field(module, field)};
        return new GuiCRIMSON.Button(
    ...
    public static GuiCRIMSON.Button createInt(int min, int max, int step, String string, Module module, String field) {
        return Setting.createInt(min, max, step, string, module, field, () -> {});
    }
    
    public static GuiCRIMSON.Button createFloat(float min, float max, float step, String string, Module module, String field) {
    ...
    public static GuiCRIMSON.Button createSecureFloat(int min, int max, int step, int dec, String string, Module module, String field) {
    ...
    public static GuiCRIMSON.Button createBoolean(String string, Module module, String field) {
    ...
    public static GuiCRIMSON.Button createKey(String string, Module.KeyBind keyBind) {
        return new GuiCRIMSON.Button(
